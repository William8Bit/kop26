...
function after_create_entry(entry) 
    ...
    GMNotice("Announcement: Ascaron region at ["..posx..","..posy.."] emerges a portal that leads to [Demonic World].") --通知本组服务器的所有玩家
	local EntryName = "Demonic World Portal"
    SetMapEntryEventName( entry, EntryName )
end

function after_destroy_entry_puzzleworld(entry)
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) 
    GMNotice("Announcement: Portal to [Demonic World] has vanished. Enjoy!") 
